...
@SqlResultSetMapping(name = "highAvailResult", classes = {
		@ConstructorResult(targetClass = dashboard.atmandcam.model.AvailabilityPerRegion.class, columns = {
...
@Entity
public class AvailabilityPerRegion {
	...
	public AvailabilityPerRegion(String regionIsocode, double totalUpPercentage) {
		super();
		this.regionIsoCode = regionIsocode;
		this.totalUpPercentage = totalUpPercentage;
	}
	
	public AvailabilityPerRegion() { }
}
